...
public class ArmPreset {
    ...
    public static final ArmPosition HIGH_DROP_ZONE = new ArmPosition(0.8, 0.45, 45.0);

    public static final ArmPosition PICK_UP_CONE_LOW = new ArmPosition(0.8, 0.06, -135.0);
    ...
    public static final ArmPosition PICK_UP_CUBE_MID = new ArmPosition(0.59, 0.28, 160.);
    ...
    public static final ArmPosition SCORE_CUBE_LOW= new ArmPosition(0.8, -0.15, 45.0);
