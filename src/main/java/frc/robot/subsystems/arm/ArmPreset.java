...
public class ArmPreset {
    ...
    public static final ArmPosition STOWED = new ArmPosition(0.30, 0.16, 0.0, ArmState.Stowed);

    public static final ArmPosition DROP_ZONE = new ArmPosition(1.01, 0.16, 0.0, ArmState.Ready);

    public static final ArmPosition PICK_UP_CONE_LOW= new ArmPosition(1.01, -0.02, 45, ArmState.Ready);
    public static final ArmPosition PICK_UP_CONE_MID = new ArmPosition(1.01, 0.71, 45, ArmState.Ready);
    public static final ArmPosition PICK_UP_CONE_HIGH = new ArmPosition(1.16, 0.97, 45, ArmState.Ready);
