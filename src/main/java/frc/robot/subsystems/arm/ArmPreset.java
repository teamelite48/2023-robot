...
public class ArmPreset {
    ...
    public static final ArmPosition STOWED = new ArmPosition(0.2, 0.16, 90, ArmState.Stowed);

    public static final ArmPosition DROP_ZONE = new ArmPosition(0.6, 0.16, 90, ArmState.Ready);

    public static final ArmPosition PICK_UP_CONE_LOW= new ArmPosition(0.6, -0.07, 45, ArmState.Ready);
    ...
    public static final ArmPosition PICK_UP_CUBE_LOW = new ArmPosition(0.5, 0.5, 45, ArmState.Ready);
