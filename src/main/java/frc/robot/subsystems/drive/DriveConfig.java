...
public class DriveConfig {
    ...
    public static final double FRONT_LEFT_ANGLE_OFFSET_DEGREES = 280.250 + 180.0;
    ...
    public static final double FRONT_RIGHT_ANGLE_OFFSET_DEGREES = 127.265;
    ...
    public static final double BACK_LEFT_ANGLE_OFFSET_DEGREES = 240.205 + 180.0;
    ...
    public static final double BACK_RIGHT_ANGLE_OFFSET_DEGREES = 204.521;

    public static final double MAX_OUTPUT = 0.9;
    public static final double LOW_GEAR_SPEED = 0.4;
